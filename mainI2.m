...
%     saveas(fig_espace_guassien,"Figures/FiguresOPEspaceGaussien/20142018/Courbe de conception " + nomCentraletGroupe +".png")
    ...
    saveas(fig_carac,'Figures/FiguresOP_20142018_carac/'+nomCentraletGroupe+'.png');
    saveas(fig_sanscarac,'Figures/FiguresOP_20142018_sanscarac/'+nomCentraletGroupe+'.png');
...
tablenom.Properties.VariableNames = ["Nom_I2"];


tableResultats = array2table(resultats_finaux(:,:));
tableResultats.Properties.VariableNames =   ["Num_Centrale_I2","Num_Alternateur_I2","Beta_ete_I2","Beta_ete_active","Beta_ete_reactive","Beta_hiver_I2",...
...
tableResultats = horzcat(tablenom,tableResultats);
 ...
 tableResultatsReduits20142018 = tableResultats(:,[1 2 3 4 7 12 13]);
 
 
 tableDepassement20142018 = tableResultats(:,[1 2 3 13]);
 

writetable( tableResultatsReduits20142018,'Résultats/BETA_PARC_HYDRO_I2.csv','Delimiter',';');
writetable( tableDepassement20142018,'Résultats/Depassement_PARC_HYDRO_I2.csv','Delimiter',';');
